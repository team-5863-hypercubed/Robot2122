...
import frc.robot.subsystems.LimeControlMode;
import frc.robot.subsystems.LimeControlMode.Advanced_Crosshair;
import frc.robot.subsystems.LimeControlMode.Advanced_Target;
import frc.robot.subsystems.LimeControlMode.CamMode;
import frc.robot.subsystems.LimeControlMode.LedMode;
import frc.robot.subsystems.LimeControlMode.Snapshot;
import frc.robot.subsystems.LimeControlMode.StreamType;
...
// here. Call these from Commands.
     ...
     */
    public limeMaster(String tableName) {
     ...
     */
    public limeMaster(NetworkTable table) {
        m_table = table;
        //ToDo
